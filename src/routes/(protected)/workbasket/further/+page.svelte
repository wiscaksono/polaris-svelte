<script lang="ts">
	...
	const query = createQuery(workbasketQueries.furtherList({ pageSize: 200, pageNumber: 1 }));
</script>
...
<header class="flex flex-col items-center justify-between gap-2 border-b px-4 py-[14px] md:flex-row">
	<h1 class="w-full text-left text-xl font-medium">Further</h1>
...
<TicketTable queryResult={query} listKey="further" />
