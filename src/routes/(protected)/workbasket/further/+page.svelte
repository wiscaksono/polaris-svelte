...
<section class="flex flex-col items-center justify-between gap-2 border-b px-4 py-[14px] md:flex-row">
	<h1 class="w-full text-left text-xl font-medium text-primary">Further ({query.data?.totalRecord ?? 0} items)</h1>
...
<TicketTable type="Further" queryResult={query} listKey="further" pageSize={queryParams.pageSize.current} />
