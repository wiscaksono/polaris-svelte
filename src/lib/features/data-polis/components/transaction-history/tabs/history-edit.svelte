<script lang="ts">
	...
	const query = createQuery(() => dataPolisTransactionHistoryQueries.historyEdit(regSpaj));
</script>

<section>
	<Heading title="History Edit" description="All changes made to this policy are recorded below with full details." />
