...
export function getInitialValues(data?: DataPertanggunganRes['data_pertanggungan']['manfaat_asuransi_tambahan']): DataPertanggunganRes['data_pertanggungan']['manfaat_asuransi_tambahan'][number] {
