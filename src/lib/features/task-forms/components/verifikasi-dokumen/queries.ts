...
export const verifikasiDokumenQueries = {
  ...
  uploadDocument: () => {
    return mutationOptions({
      mutationFn: async ({ file, regSpaj, noTrx, idTrx, idJn, flag, purpose = 'STORAGE' }: { file: File, regSpaj: string, noTrx: string, idTrx: string, idJn: string, flag: string, purpose?: string }) => {
