	...
	<Dialog.Content onEscapeKeydown={handleCloseAttempt} onInteractOutside={handleCloseAttempt} class="max-h-[95svh] overflow-y-auto">
		...
		<div class="-mx-6 max-h-[75svh] space-y-4 overflow-y-auto px-6">
			<div class="space-y-2">
				...
				<Textarea id="detail-alamat" placeholder="Detail Alamat" />
			</div>
			<div class="space-y-2">
				...
				>
					<Select.Trigger id="negara" class="w-full">{values.negara.label}</Select.Trigger>
			...
			<div class="space-y-2">
				...
				>
					<Select.Trigger id="provinsi" class="w-full">{values.provinsi.label}</Select.Trigger>
			...
			<div class="space-y-2">
				...
				>
					<Select.Trigger id="kota-atau-kabupaten" class="w-full">{values.kotaKabupaten.label}</Select.Trigger>
			...
			<div class="space-y-2">
				...
				>
					<Select.Trigger id="kecamatan" class="w-full">{values.kecamatan.label}</Select.Trigger>
			...
			<div class="space-y-2">
				...
				>
					<Select.Trigger id="kelurahan" class="w-full">{values.kelurahan.label}</Select.Trigger>
