...
export interface MajorAlterationTab2Res {
	...
	pemegangPolis: {
		...
		alamat: TrackedData<{
			...
			pekerjaan: Omit<MajorAlterationTab2Res['pemegangPolis']['alamat']['before']['rumah'], 'alamatKorespondensi'>;
			domisili: Omit<MajorAlterationTab2Res['pemegangPolis']['alamat']['before']['rumah'], 'alamatKorespondensi'>;
		}>;
	...
	tertanggungUtama: {
		...
		alamat: TrackedData<{
			...
			pekerjaan: MajorAlterationTab2Res['tertanggungUtama']['alamat']['before']['rumah'];
			domisili: MajorAlterationTab2Res['tertanggungUtama']['alamat']['before']['rumah'];
		}>;
	};
	sar: {
